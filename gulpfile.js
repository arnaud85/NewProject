...
gulp.task('style', function() {
    ...
    return gulp.src([devFolder.sass + 'materialize.css', devFolder.sass + 'prism.css', devFolder.sass + "*.scss"])
        .pipe(plumber({
...
gulp.task('scripts', function() {
    ...
    return gulp.src([devFolder.js+'jquery-2.1.4.js', devFolder.js+'materialize.js', devFolder.js+'prism.js', devFolder.js+'app.js'])
        .pipe(plumber())
